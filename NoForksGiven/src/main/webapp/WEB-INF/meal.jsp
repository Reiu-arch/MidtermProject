...
<body>
    ...
    <div class="meal-details">
        ...
        <div class="action-buttons">
            <a href="browseResults.do" class="add-recipe-button">Add Recipes to Meal</a>
            <a href="updateMeal.do?mealId=${meal.id}" class="edit-button">Edit Meal</a>
            <form action="deleteMeal.do" method="GET" class="action-form" onsubmit="return window.confirm('Confirm Delete?');">
