...
<body>
	...
	<form action="createrecipe.do" method="POST">
		...
		<input type="text" id="description" name="description" size="80" required>

		<label for="prepTimeMin">Enter the prep time in minutes:</label>
		<input type="number" id="prepTimeMin" name="prepTimeMin" required>

		<label for="cookTimeMin">Enter the cook time in minutes:</label>
		<input type="number" id="cookTimeMin" name="cookTimeMin" required>

		<label for="instructions">Enter the recipe's instructions:</label>
		<textarea id="instructions" name="instructions" rows="5" required></textarea>

		<label for="servings">Enter the serving size:</label>
